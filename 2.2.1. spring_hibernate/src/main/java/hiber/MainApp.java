...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      User user1 = new User("User111sss", "Lastname111", "user111@mail.ru");
      User user2 = new User("User12sss", "Lastname1211", "user1211@mail.ru");
      User user3 = new User("User131sss", "Lastname1311", "user1311@mail.ru");
